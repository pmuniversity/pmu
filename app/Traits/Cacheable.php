...
trait Cacheable
{
    ...
    {
        $keysFile = $this->getContainer('config')->get('cache.strategy.keys_file');
    ...
    protected function flushCacheKeys()
    {
        ...
        $config = $this->getContainer('config')->get('cache.strategy');
    ...
    {
        $lifetime = $this->getContainer('config')->get('cache.strategy.lifetime');
