...
$(function() {
	...
	$('.datatable-button-html5-user-columns')
			.DataTable(
					{
						buttons : {
							buttons : [
						...
						"ajax" : {
							url : '/admin/datatable-users',
							type : 'POST'
						}
					});
	// Topic Column selectors
	$('.datatable-button-html5-topic-columns')
			.DataTable(
					{
						buttons : {
							buttons : [
						...
						"ajax" : {
							url : '/admin/datatable-topics',
							type : 'POST'
						}
					});
	$('.datatable-button-html5-topic-by-level-columns')
			.DataTable(
					{
						buttons : {
							buttons : [
						...
						"ajax" : {
							url : '/admin/datatable-topics-by-level',
							type : 'POST',
							data : {
								levelId : $("#levelId").html()
							}
						}
					});
	$('.datatable-button-html5-article-columns')
			.DataTable(
					{
						buttons : {
							buttons : [
						...
						"ajax" : {
							url : '/admin/datatable-articles',
							type : 'POST',
							data : {
								topicId : $("#titleId").html()
							}
						}
					});
