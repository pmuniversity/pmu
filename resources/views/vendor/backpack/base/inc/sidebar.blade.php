...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                <a href="#"><i class="fa fa-newspaper-o"></i> <span>Topics</span> <i
                            class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                    <li><a href="{{ url('admin/topic') }}"><i class="fa fa-newspaper-o"></i> <span>List</span></a>
                    </li>
            ...
            <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/halls-of-knowledge') }}">
                    <i class="fa fa-file-o"></i>
                    <span>Hall of Knowledge</span>
                </a>
            </li>
            <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/log') }}"><i class="fa fa-terminal"></i>
                    <span>Logs</span></a></li>
            <!-- ======================================= -->
