...
<div class="navbar navbar-inverse">
	<div class="navbar-header">
		<a class="navbar-brand" href="index.html"><img
			src="/assets/admin/images/logo_light.png" alt=""></a>
			...
			<ul class="nav navbar-nav">
						...
						<ul class="media-list dropdown-content-body width-300">
							<li class="media">
								...
								<div class="media-body">
									...
									<span class="display-block text-muted text-size-small">Lead web
										developer</span>
								</div>
							...
							<li class="media">
								...
								<div class="media-body">
									...
									<span class="display-block text-muted text-size-small">Project
										manager</span>
								</div>
								<div class="media-right media-middle">
									<span class="status-mark border-success"></span>
							...
							<li class="media">
								<div class="media-left">
									<img src="/assets/admin/images/demo/users/face19.jpg"
										class="img-circle img-sm" alt="">
								</div>
								<div class="media-body">
									<a href="#" class="media-heading text-semibold">Dori Laperriere</a>
									<span class="display-block text-muted text-size-small">Business
										developer</span>
								</div>
								<div class="media-right media-middle">
							...
							<li class="media">
								<div class="media-left">
									<img src="/assets/admin/images/demo/users/face16.jpg"
										class="img-circle img-sm" alt="">
								</div>
								<div class="media-body">
					...
					<div class="dropdown-menu dropdown-content width-350">
						...
						<ul class="media-list dropdown-content-body">
							<li class="media">
								...
								<div class="media-body">
									<a href="#" class="media-heading"> <span class="text-semibold">James
											Alexander</span> <span class="media-annotation pull-right">04:58</span>
							...
							<li class="media">
								...
								<div class="media-body">
									<a href="#" class="media-heading"> <span class="text-semibold">Margo
											Baker</span> <span class="media-annotation pull-right">12:16</span>
									</a> <span class="text-muted">That was something he was unable
										to do because...</span>
								</div>
							</li>
							...
							<li class="media">
								...
								<div class="media-body">
									<a href="#" class="media-heading"> <span class="text-semibold">Jeremy
											Victorino</span> <span class="media-annotation pull-right">22:48</span>
							...
							<li class="media">
								...
								<div class="media-body">
									<a href="#" class="media-heading"> <span class="text-semibold">Beatrix
											Diaz</span> <span class="media-annotation pull-right">Tue</span>
							...
							<li class="media">
								...
								<div class="media-body">
									<a href="#" class="media-heading"> <span class="text-semibold">Richard
											Vango</span> <span class="media-annotation pull-right">Mon</span>
									</a> <span class="text-muted">Other travelling salesmen live a
										life of luxury...</span>
								</div>
							</li>
						</ul>
				...
				<li class="dropdown dropdown-user"><a class="dropdown-toggle"
					data-toggle="dropdown"> <img
						src="/assets/admin/images/demo/users/face11.jpg" alt=""> <span>{{ Auth::user()->full_name }}</span>
						<i class="caret"></i>
				</a>
