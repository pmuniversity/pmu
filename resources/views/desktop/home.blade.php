...
<head>
    ...
    <link rel="shortcut icon" href="{{ config('blog.default_desktop_icon') }}">
    ...
    <!--Header-->
        ...
        <section class="main-banner">
            <div class="banner-logo">
                <img src="/images/{{ config('blog.desktop_title') }}/logo.png"/>
            </div>
                ...
                <div class="knowledge">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="k-list-item">
                                <div class="list-image">
                                    <img src="{{asset($hallsofKnowledge->image_1_web_picture)}}"/>
                                </div>
                                <div class="list-desc">
                        ...
                        <div class="col-md-4">
                            <div class="k-list-item">
                                <div class="list-image">
                                    <img src="{{asset($hallsofKnowledge->image_2_web_picture) }}"/>
                                </div>
                                <div class=" list-desc">
                                    <div class="list-desc-details">
                                        <p>{{$hallsofKnowledge->image_2_title}}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="k-list-item">
                                <div class="list-image">
                                    <img src="{{asset($hallsofKnowledge->image_3_web_picture)}}"/>
                                </div>
                                <div class="list-desc">
                                    <div class="list-desc-details">
